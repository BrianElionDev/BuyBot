...
class DatabaseManager:
    ...
    async def execute_query(self, query_builder, cache_key: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.config.enable_query_logging:
                logger.debug(f"Executing query: {query_builder}")
    ...
    async def insert(self, table: str, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.debug(f"Inserted data into {table}: {result}")
            return result
        except Exception as e:
    ...
    async def update(self, table: str, data: Dict[str, Any], 
        ...
        try:
            ...
            result = await self.execute_query(query)
            logger.debug(f"Updated data in {table}: {result}")
            return result
    ...
    async def delete(self, table: str, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.execute_query(query)
            logger.debug(f"Deleted data from {table}: {result}")
            return result
